...
class CollaboratorFactory extends Factory
{
  ...
  {
    return [
      // user_id e client_id serão preenchidos via ->for()
      'photo_url' => fake()->imageUrl(100,100,'people'), // fake()->imageUrl(100,100,'people')
      ...
      'is_special_needs_person' => fake()->boolean(10), // 10% de chance de ser true
      ...
      'cpf' => fake()->unique()->numerify('###########'), // 11 números
      'rg' => fake()->unique()->numerify('#######'),   // 7 números
      'cnh' => fake()->numerify('###########'),
