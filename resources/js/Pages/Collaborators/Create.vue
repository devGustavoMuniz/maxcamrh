      ...
      <div class="bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-4 md:p-8">
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <section v-if="currentStep === 1" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="md:col-span-2"
                   v-if="(userRole === 'admin' || userRole === 'franchise') && props.clients && props.clients.length > 0">
                <Label for="collaborator_client_id">Cliente Associado</Label>
                <Select v-model="form.collaborator.client_id">
                  <SelectTrigger id="collaborator_client_id" class="bg-white dark:bg-gray-700">
                    <SelectValue placeholder="Selecione um cliente"/>
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem class="cursor-pointer" v-for="client in props.clients" :key="client.id"
              ...
              <div class="md:col-span-2" v-if="userRole === 'client'">
                <p
                  ...
                  Este colaborador será associado automaticamente ao seu perfil de cliente.</p>
              </div>
              <div>
                <Label for="user_name">Nome Completo</Label>
                <Input id="user_name" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="user_email" type="email" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.user.email" required/>
                <InputError class="mt-2" :message="form.errors['user.email']"/>
              </div>
              <div>
                <Label for="user_password">Senha</Label>
                <Input id="user_password" type="password" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.user.password" required/>
              ...
              <div>
                ...
                <Input id="user_password_confirmation" type="password"
                       class="mt-1 block w-full bg-white dark:bg-gray-700" v-model="form.user.password_confirmation"
                       required/>
              </div>
              <div>
                <Label for="collaborator_date_of_birth">Data de Nascimento</Label>
                <Input id="collaborator_date_of_birth" type="date" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_scholarity" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_father_name" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_mother_name" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_nationality" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div class="flex items-center space-x-2 self-end pb-1">
                <Checkbox id="collaborator_is_special_needs_person"
                          v-model:checked="form.collaborator.is_special_needs_person"/>
          ...
          <section v-if="currentStep === 2" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input id="collaborator_personal_email" type="email" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_business_email" type="email" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_phone" type="tel" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.collaborator.phone" v-mask="['(##) ####-####', '(##) #####-####']"/>
                <InputError class="mt-2" :message="form.errors['collaborator.phone']"/>
              </div>
              <div>
                <Label for="collaborator_cellphone">Celular</Label>
                <Input id="collaborator_cellphone" type="tel" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.collaborator.cellphone" v-mask="['(##) ####-####', '(##) #####-####']"/>
              ...
              <div class="md:col-span-2">
                ...
                <Input id="collaborator_emergency_phone" type="tel" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.collaborator.emergency_phone" v-mask="['(##) ####-####', '(##) #####-####']"/>
                <InputError class="mt-2" :message="form.errors['collaborator.emergency_phone']"/>
              </div>
              <div>
                <Label for="address_cep">CEP</Label>
                <Input id="address_cep" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.address.cep" @blur="fetchAddressByCep" v-mask="'#####-###'"/>
                <InputError class="mt-2" :message="form.errors['address.cep']"/>
              </div>
              <div>
                <Label for="address_street">Logradouro (Rua, Av.)</Label>
                <Input id="address_street" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.address.street"/>
                <InputError class="mt-2" :message="form.errors['address.street']"/>
              </div>
              <div>
                <Label for="address_number">Número</Label>
                <Input id="address_number" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.address.number"/>
                <InputError class="mt-2" :message="form.errors['address.number']"/>
              </div>
              <div>
                <Label for="address_complement">Complemento</Label>
                <Input id="address_complement" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.address.complement"/>
                <InputError class="mt-2" :message="form.errors['address.complement']"/>
              </div>
              <div>
                <Label for="address_neighborhood">Bairro</Label>
                <Input id="address_neighborhood" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.address.neighborhood"/>
                <InputError class="mt-2" :message="form.errors['address.neighborhood']"/>
              </div>
              <div>
                <Label for="address_city">Cidade</Label>
                <Input id="address_city" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.address.city"/>
                <InputError class="mt-2" :message="form.errors['address.city']"/>
              </div>
              <div>
                <Label for="address_state">Estado (UF)</Label>
                <Input id="address_state" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.address.state" maxlength="2"/>
          ...
          <section v-if="currentStep === 3" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input id="collaborator_department" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_position" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_salary" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.collaborator.salary" v-money3="moneyConfig"/>
              ...
              <div>
                ...
                <Input id="collaborator_admission_date" type="date" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_contract_start_date" type="date"
              ...
              <div>
                ...
                <Input id="collaborator_contract_expiration" type="date"
                       class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_direct_superior_name" type="text"
                       class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div class="md:col-span-2">
                ...
                <Input id="collaborator_hierarchical_degree" type="text"
                       class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div class="md:col-span-2">
                ...
                <Textarea id="collaborator_observations" class="mt-1 block w-full bg-white dark:bg-gray-700"
                          v-model="form.collaborator.observations" rows="3"/>
          ...
          <section v-if="currentStep === 4" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input id="collaborator_cpf" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.collaborator.cpf" v-mask="'###.###.###-##'"/>
                <InputError class="mt-2" :message="form.errors['collaborator.cpf']"/>
              </div>

              <div>
                <Label for="collaborator_rg">RG</Label>
                <Input id="collaborator_rg" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.collaborator.rg" v-mask="'##.###-###'"/>
                <InputError class="mt-2" :message="form.errors['collaborator.rg']"/>
              </div>

              <div>
                <Label for="collaborator_cnh">CNH (Número)</Label>
                <Input id="collaborator_cnh" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
                       v-model="form.collaborator.cnh" v-mask="'###########'"/>
              ...
              <div>
                ...
                <Input id="collaborator_reservista" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_titulo_eleitor" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_zona_eleitoral" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_pis_ctps_numero" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_ctps_serie" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div class="md:col-span-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <input id="collaborator_photo_file" ref="photoFileInput" type="file" class="hidden"
                           @change="event => handleFileUpload(event, 'photo_file', photoPreview, true)"
                           accept="image/*"/>
                    <Button type="button" variant="outline" @click="photoFileInput?.click()"
                            class="w-full bg-white dark:bg-gray-700 justify-center">Foto (3x4)
                    </Button>
                    <img v-if="photoPreview" :src="photoPreview" alt="Preview Foto" class="mt-2 h-24 rounded mx-auto"/>
                  </div>
                  <div>
                    <input id="collaborator_curriculum_file" ref="curriculumFileInput" type="file" class="hidden"
                           @change="event => handleFileUpload(event, 'curriculum_file', curriculumFileName, false)"
                           accept=".pdf,.doc,.docx"/>
                    <Button type="button" variant="outline" @click="curriculumFileInput?.click()"
                            class="w-full bg-white dark:bg-gray-700 justify-center">Currículo
                    </Button>
                    <p v-if="curriculumFileName"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Input id="collaborator_banco" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_agencia" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
              ...
              <div>
                ...
                <Input id="collaborator_conta_corrente" type="text" class="mt-1 block w-full bg-white dark:bg-gray-700"
          ...
          <div
            ...
            <div>
              <Button type="button" variant="outline" class="bg-white dark:bg-gray-700 w-full sm:w-auto"
                      @click="prevStep" v-if="currentStep > 1">Anterior
              </Button>
            </div>
            <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
              ...
              <Button type="button"
                      ...
                      @click="nextStep" v-if="currentStep < totalSteps">Próximo
              </Button>
              <Button type="submit" variant="black"
                      ...
                      :disabled="form.processing">Salvar Colaborador
              </Button>
            </div>
          </div>
        </form>
