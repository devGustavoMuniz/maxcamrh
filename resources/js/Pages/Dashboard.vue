  ...
  <AuthenticatedLayout>
    <template #header>
      <div class="flex items-center">
        <LayoutDashboard
          class="h-6 w-6 mr-2 text-gray-700 dark:text-gray-300"
        />
        <h2
            ...
            <CardFooter>
              <Link :href="route('collaborators.index')" class="w-full">
                <Button
                  variant="outline"
                  class="w-full bg-gray-800 text-white hover:bg-gray-700 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
                  >Gerenciar Colaboradores</Button
                >
              </Link>
            </CardFooter>
          </Card>
            ...
            <CardFooter>
              <Link :href="route('clients.index')" class="w-full">
                <Button
                  variant="outline"
                  class="w-full bg-gray-800 text-white hover:bg-gray-700 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
                  >Gerenciar Meus Clientes</Button
                >
              </Link>
            </CardFooter>
          </Card>
          <Card>
            ...
            >
              <CardTitle class="text-sm font-medium"
                >Colaboradores (dos Clientes)</CardTitle
              >
              <Users class="h-5 w-5 text-muted-foreground" />
            </CardHeader>
            <CardContent>
            ...
            <CardFooter>
              <Link :href="route('collaborators.index')" class="w-full">
                <Button
                  variant="outline"
                  class="w-full bg-gray-800 text-white hover:bg-gray-700 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
                  >Gerenciar Meus Colaboradores</Button
                >
              </Link>
            </CardFooter>
          </Card>
          ...
          <Card>
            <CardContent class="p-6">
              <p class="text-gray-700 dark:text-gray-300">
                Nenhuma informação específica para exibir no dashboard para seu
                perfil.
              </p>
            </CardContent>
          </Card>
