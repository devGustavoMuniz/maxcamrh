            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="client_cnpj" type="text" class="mt-1 block w-full" v-model="form.cnpj" v-mask="'##.###.###/####-##'" required />
                  <InputError class="mt-2" :message="form.errors.cnpj" />
                </div>
                <div>
                  <Label for="client_phone">Telefone</Label>
                  <Input id="client_phone" type="text" class="mt-1 block w-full" v-model="form.phone" v-mask="['(##) ####-####', '(##) #####-####']" />
