    ...
    <div class="mx-auto w-full">
        <div class="bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="space-y-4">
              <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 border-b dark:border-gray-700 pb-2">Dados da Empresa Cliente</h3>
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label for="client_cnpj">CNPJ</Label>
                  <Input id="client_cnpj" type="text" class="mt-1 block w-full bg-white" v-model="form.cnpj" v-mask="'##.###.###/####-##'" required />
                  <InputError class="mt-2" :message="form.errors.cnpj" />
                </div>
                <div>
                  <Label for="client_phone">Telefone</Label>
                  <Input id="client_phone" type="text" class="mt-1 block w-full bg-white" v-model="form.phone" v-mask="['(##) ####-####', '(##) #####-####']" />
                ...
                <div>
                  ...
                  <Input id="client_contract_end_date" type="date" class="mt-1 block w-full bg-white" v-model="form.contract_end_date" />
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-center pt-2">
                <div>
                  ...
                  <div class="mt-1 flex items-center gap-4">
                    ...
                    <Button type="button" variant="outline" class="bg-white" @click="selectNewLogo">
                      Escolher Arquivo
                    </Button>
                    <div v-if="logoPreview">
                      <img :src="logoPreview" alt="Preview do Logo" class="h-12 w-auto rounded-md object-cover" />
                    </div>
                  </div>
