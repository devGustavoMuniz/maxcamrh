  ...
  <section class="space-y-6">
    <header>
      ...
      <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
        ...
        quaisquer dados ou informações que você deseja manter.
      </p>
    </header>
    ...
    <Modal :show="confirmingUserDeletion" @close="closeModal">
      <div class="p-6">
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Uma vez que sua conta for excluída, todos os seus recursos e dados serão
          permanentemente excluídos. Digite sua senha para confirmar que você
          gostaria de excluir permanentemente sua conta.
        </p>
