            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input id="user_password" type="password" class="mt-1 block w-full bg-white" v-model="form.password" required />
                  <InputError class="mt-2" :message="form.errors.password" />
                </div>
                <div>
                  <Label for="user_password_confirmation">Confirmar Senha</Label>
                  <Input id="user_password_confirmation" type="password" class="mt-1 block w-full bg-white" v-model="form.password_confirmation" required />
            ...
            <div class="space-y-4">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="franchise_maxcam_email" type="email" class="mt-1 block w-full bg-white" v-model="form.maxcam_email" required />
                  <InputError class="mt-2" :message="form.errors.maxcam_email" />
                </div>
                <div>
                  <Label for="franchise_cnpj">CNPJ</Label>
                  <Input id="franchise_cnpj" type="text" class="mt-1 block w-full bg-white" v-model="form.cnpj" v-mask="'##.###.###/####-##'" required />
                  <InputError class="mt-2" :message="form.errors.cnpj" />
                </div>
                <div>
                  <Label for="franchise_max_client">Máximo de Clientes</Label>
                  <Input id="franchise_max_client" type="number" class="mt-1 block w-full bg-white" v-model.number="form.max_client" required min="0" />
                ...
                <div>
                  ...
                  <Input id="franchise_contract_start_date" type="date" class="mt-1 block w-full bg-white" v-model="form.contract_start_date" required />
                ...
                <div>
                  ...
                  <Input id="franchise_actuation_region" type="text" class="mt-1 block w-full bg-white" v-model="form.actuation_region" required />
                ...
                <div class="md:col-span-2">
                  ...
                  <Textarea id="franchise_observations" class="mt-1 block w-full bg-white" v-model="form.observations" rows="3" />
